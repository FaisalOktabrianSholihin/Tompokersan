        ...
        <div class="card-body">
            <div class="container mt-5">
                <div class="row">
                    <div class="col-md-6">
                        <h2>Tentang</h2>
                        <p> Tompokersan merupakan aplikasi berbasis website dan mobile ini dapat
                        ...
                        <p>
                            Tompokersan termasuk upaya meningkatkan transparansi, kontrol serta
                        ...
                        <p>
                            Fitur Fitur Aplikasi Tompokersan
                        </p>
                    </div>
                    <div class="col-md-6">
